...
export function EducationTabs({ photos }: { photos: EducationPhotoItem[] }) {
  ...
  const activeTabItem = EDUCATION_TABS.find((tab) => tab.key === activeTab) ?? EDUCATION_TABS[0];
    ...
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-14">
      <div className="grid gap-8 lg:grid-cols-[280px_minmax(0,1fr)]">
        <aside className="lg:sticky lg:top-24 lg:self-start">
          <div className="overflow-hidden rounded-lg border border-border bg-card">
            <div className="border-b border-border px-4 py-3">
              <h2 className="text-base font-semibold">{t("nav.education")} media</h2>
        ...
        <main className="min-w-0">
          <nav aria-label="Education sections" className="mb-6 flex flex-wrap gap-2">
          ...
          <section className="mt-8 rounded-lg bg-[#0f766e] px-5 py-6 text-white sm:px-7">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <h2 className="text-xl font-semibold">Need education support?</h2>
                <p className="mt-2 max-w-2xl text-sm leading-relaxed text-white/85">
                  Contact the community team for classes, programs, and learning resources.
                </p>
              </div>
              <Link
                href="/contact"
    ...
    <div className="space-y-5">
      <div className="flex gap-4">
        ...
        <div>
          ...
          <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
            This section is ready for education page content. The title and details can be updated later.
          </p>
        </div>
      </div>
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        ...
        <div className="rounded-md border border-border bg-background p-4">
          ...
          <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
            Add links, schedules, documents, or learning instructions here.
          </p>
        </div>
      </div>
    </div>
